...
Write-Host "  python chronogrid_gui.py    # GUI" -ForegroundColor White
Write-Host "  python chronogrid.py video.mp4    # CLI" -ForegroundColor White
